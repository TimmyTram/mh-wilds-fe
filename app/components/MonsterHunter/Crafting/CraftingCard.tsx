...
const CraftingCard = ({ craftingCost }: CraftingCardProps) => {
    return (
        <Link href={`/items/${craftingCost.item.id}`} className="flex flex-col items-center p-4 rounded-lg border-4 w-1/2 hover:text-amber-500 hover:border-amber-500 transition duration-300 ease-in-out">
